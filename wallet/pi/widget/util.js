 ...
 *
 */
exports.getDefaultSuffixCfg = function () {
    return Object.assign({}, suffix_cfg);
};
/**
...
var loadTpl1 = function loadTpl1(file, fileMap, widget) {
    ...
    if (!tpl) {
        ...
        if (isDebug) {
            tpl.value = toFun(mod_1.butil.utf8Decode(fileMap[s]), s);
        } else {
            tpl.value = toMiniFun(mod_1.butil.utf8Decode(fileMap[s]), s);
        }
    }
    return tpl;
};
...
var stringifyName = '_stringify';
var getName = '_get';
var hashName = '_hash';
var pathName = '_path';
var convertEntityName = '_convertEntity';
var calAttrHashName = '_calAttrHash';
var calTextHashName = '_calTextHash';
var addJsonName = '_addJson';
var installTextName = '_installText';
var addTextName = '_addText';
var chFuncName = '_chFunc';
 ...
 * @example
 */
var toFun = function toFun(s, path) {
    try {
        // tslint:disable-next-line:no-function-constructor-with-string-args
        return new Function(stringifyName, getName, hashName, pathName, convertEntityName, calAttrHashName, calTextHashName, addJsonName, installTextName, addTextName, chFuncName, 'return' + s)(exports.toString, mod_1.commonjs ? mod_1.commonjs.relativeGet : null, hash, path, exports.convertEntity, exports.calAttrHash, exports.calTextHash, exports.addJson, exports.installText, exports.addText, exports.chFunc);
    } catch (e) {
 ...
 * @example
 */
var toMiniFun = function toMiniFun(s, path) {
    try {
        // tslint:disable-next-line:no-function-constructor-with-string-args
        return new Function('return ' + s)()(exports.toString, mod_1.commonjs ? mod_1.commonjs.relativeGet : null, hash, path, exports.convertEntity, exports.calAttrHash, exports.calTextHash, exports.addJson, exports.installText, exports.addText, exports.chFunc);
    } catch (e) {
        log_1.warn(exports.level, 'tpl toFun, path: ' + path + ', s: ', s, e);
        throw e;
    }
